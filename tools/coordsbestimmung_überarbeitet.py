...
appereance_mode = ctypes.c_int(2)                                                                                       # appereance_mode: Variable zum Speichern des Anzeigemodus der Titelleiste // 0 = Light Mode, 1 = Dark Mode, 2 = Systemstandart
...
widget_dic = {
    ...
    "status_title_label": epw.Label(text="Status", font=epw.SysFont(font="Calibri", font_size=30), alignment_spacing = 0),
        ...
        if event.type == pygame.VIDEORESIZE:
            ...
            if shape == 1:
                ...
                if w_coords_count == 0:
                    ...
                    widget_dic["status_label"].config(text = f"Die Koordinate{s_x1}, {s_y1} wurde hinzugefügt.")
                    if w_coords_count == 1:
                        w_submit = True
                else:
